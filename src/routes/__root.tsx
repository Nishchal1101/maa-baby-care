  ...
  head: () => ({
    meta: [
      ...
      { title: "Maatri  -  Pregnancy care for Indian mothers" },
      {
        name: "description",
        content:
          "Maatri is a gentle pregnancy companion built for Indian mothers  -  week-by-week tracking, Indian diet plans, ANC reminders, kick counter, and more.",
      },
      { property: "og:title", content: "Maatri  -  Pregnancy care for Indian mothers" },
      {
