    ...
    <MobileShell>
      <div className="px-5 pb-6 pt-4">
        ...
        {maternalVaccines.map((v) => (
          <section key={v.name} className="mt-4 rounded-2xl bg-card p-4 shadow-sm">
        ...
        <section className="mt-4 rounded-2xl border border-destructive/20 bg-destructive/5 p-4">
