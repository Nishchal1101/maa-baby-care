...
const data: Partial<Record<number, Omit<WeekInfo, "week">>> = {
  ...
  18: { size: "aam (mango)", babyDev: "Baby moves a lot; gender visible on scan.", momChange: "You may feel first flutters.", tip: "Schedule your anomaly scan (18–22 weeks)." },
  20: { size: "shakarkand (sweet potato)", babyDev: "Halfway there! Baby is swallowing.", momChange: "Round ligament pain possible.", tip: "Drink 2.5–3L water daily; sip nimbu pani." },
